            ...
            <table class="table w-full">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-600 transition duration-150">
                        ...
                        <td class="px-6 py-2 font-mono text-sm text-blue-600 dark:text-blue-400">{{ $requesttype->name_th }}</td>
                        ...
                        <td class="px-6 py-2 text-gray-500 dark:text-gray-400 truncate max-w-xs" title="{{ $requesttype->description }}">
                        ...
                        <td class="px-6 py-2 text-center space-x-2">
                            <button type="button" class="btn btn-warning btn-sm btn-square text-white editBtn shadow-sm"
                                ...
                                data-code="{{ $requesttype->code }}"
                                data-name_th="{{ $requesttype->name_th }}"
...
<div id="createModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 backdrop-blur-sm transition-opacity">
        ...
        <form method="POST" action="{{ route('request-types.store') }}" class="px-6 mb-4 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input name="name_th" type="text" class="input input-bordered w-full dark:text-black" placeholder="เช่น คำร้องทั่วไป" required />
            ...
            <div>
                ...
                <textarea name="description" rows="3" class="textarea textarea-bordered w-full dark:text-black"></textarea>
            </div>
...
<div id="editModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 backdrop-blur-sm">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-lg">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <h2 class="text-lg font-bold text-gray-800 dark:text-gray-100"><i class="fa-solid fa-edit mr-2 text-yellow-500"></i>แก้ไขตัวเลือกการร้องขอ</h2>
        ...
        <form method="POST" id="editForm" class="px-6 mb-4 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input name="name_th" id="edit_name_th" type="text" class="input input-bordered w-full dark:text-black" required />
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">สถานะ</label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">คำอธิบาย</label>
                <textarea name="description" id="edit_description" rows="3" class="textarea textarea-bordered w-full dark:text-black"></textarea>
            </div>
            <div class="flex justify-end space-x-3 pt-4 border-t border-gray-100 dark:border-gray-700 mt-4">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-md transform transition-all scale-100">
        <div class="p-6 text-center">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-300 mb-6">
                คุณต้องการลบรายการ <span id="deleteName" class="font-bold text-gray-800 dark:text-white"></span> ใช่หรือไม่?<br>
