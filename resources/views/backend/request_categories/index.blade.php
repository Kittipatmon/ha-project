            ...
            <table class="table w-full">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-600 transition duration-150">
                        ...
                        <td class="px-6 py-2 font-mono text-sm text-blue-600 dark:text-blue-400">{{ $category->name_th }}</td>
                        ...
                        <td class="px-6 py-2 text-gray-500 dark:text-gray-400 truncate max-w-xs" title="{{ $category->description }}">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-lg transform transition-all scale-100">
        ...
        <form method="POST" action="{{ route('request-categories.store') }}" class="px-6 mb-4 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">ชื่อ (TH) <span class="text-red-500">*</span></label>
...
<div id="editModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 backdrop-blur-sm">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-lg">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <h2 class="text-lg font-bold text-gray-800 dark:text-gray-100"><i class="fa-solid fa-edit mr-2 text-yellow-500"></i>แก้ไขประเภทคำร้อง</h2>
