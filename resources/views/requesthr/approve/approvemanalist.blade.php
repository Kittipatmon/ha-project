...
<div class="max-w-8xl mx-auto px-4 py-3">
    <div class="breadcrumbs text-sm">
        <ul>
            ...
            <li class="text-red-600">รายงานคำร้องขอ (รอตรวจสอบ/อนุมัติ)</li>
        </ul>
    </div>
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="text-sm text-gray-700 dark:text-gray-300">
                            ...
                            <a href="{{ route('requesthr.detailMana', $request->hr_request_id ) }}" class="btn btn-warning btn-sm hover:underline">
