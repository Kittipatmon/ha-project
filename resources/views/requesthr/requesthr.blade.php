                ...
                <div class="card-body p-2 md:p-4">
                    ...
                    <form id="hrRequestForm" enctype="multipart/form-data">
                        <div class="text-sm text-gray-500 mb-4 flex items-center gap-2">
                            <i class="fa-solid fa-circle-info text-info"></i> กรุณากรอกข้อมูลให้ครบถ้วน
                            (จำเป็นต้องระบุ)<span class="text-error">*</span>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                            <div class="form-control w-full">
                                <label class="label font-medium">
                                    <span class="label-text">หมวดคำร้อง (Request Category) <span
                            ...
                            <div class="form-control w-full">
                                <label class="label font-medium">
                                    <span class="label-text">ประเภทคำร้อง (Request Type) <span
                                            class="text-error">*</span></span>
                                </label>
                                <select id="typeSelect" name="type_id"
                                    class="select select-bordered w-full transition-colors" disabled>
                            ...
                            <div class="form-control w-full">
                                <label class="label font-medium">
                                    <span class="label-text">ตัวเลือกรายละเอียด (Request Subtype) <span
                                            class="text-error">*</span></span>
                                </label>
                        ...
                        <div class="card-actions justify-end mt-8 pt-4 border-t border-gray-100">
                            <a href="{{ route('request.hr') }}" class="btn btn-secondary">
                                <i class="fa-solid fa-xmark"></i> ยกเลิก
                            </a>
                            <button type="button" class="btn btn-success px-8 text-white shadow-lg shadow-primary/30"
                                onclick="submitForm()">
